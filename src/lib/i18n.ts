...
const translations: Record<Language, TranslationDict> = {
  es: {
    ...
    onboarding: {
      ...
      goAddSubscription: 'Añadir primera suscripción',
    },
    settings: {
      ...
      baseCurrencyDefaultHint: 'Se usa también como moneda por defecto para nuevas suscripciones.',
    ...
    subscriptions: {
      ...
      detailTitle: 'Detalle de suscripción',
      amount: 'Importe',
      currency: 'Moneda',
      period: 'Periodo',
    ...
    dashboard: {
      ...
      trendWindow: 'Tendencia',
      projectionWindow: 'Proyección',
      trendTitle: 'Tendencia mensual',
      projectionTitle: 'Proyección de gasto',
      lastMonth: 'Último mes',
      momChange: 'Cambio MoM',
      momPct: '% MoM',
      momComparisons: 'Comparativas mes a mes',
      nextMonthProjection: 'Próximo mes',
      projectionTotal: 'Total {{months}}m',
      subscriptionCompareTitle: 'Comparativa entre suscripciones',
      needMoreSubs: 'Añade al menos dos suscripciones para comparar.',
      compareA: 'Suscripción A',
      compareB: 'Suscripción B',
      comparePlaceholder: 'Selecciona dos suscripciones para comparar.',
      compareDifferentCurrencyHint: 'Las suscripciones tienen monedas distintas. Activa “convertir a moneda base” para comparar.',
      monthlyCost: 'Mensual',
      annualCost: 'Anual',
      diffLabel: 'Diferencia (A - B)',
  ...
  en: {
    ...
    onboarding: {
      ...
      goAddSubscription: 'Add first subscription',
    },
    settings: {
      groupGeneral: 'General',
      ...
      baseCurrencyDefaultHint: 'Also used as default currency for new subscriptions.',
    ...
    subscriptions: {
      ...
      groupByCategory: 'Group by categories',
    ...
    dashboard: {
      ...
      fxIdle: '—',
      advancedSummaryTitle: 'Financial overview',
      ...
      projectionTitle: 'Spend projection',
      lastMonth: 'Last month',
      momChange: 'MoM change',
      momPct: '% MoM',
      momComparisons: 'Month-over-month comparisons',
      nextMonthProjection: 'Next month',
      projectionTotal: 'Total {{months}}m',
      subscriptionCompareTitle: 'Subscription comparison',
      needMoreSubs: 'Add at least two subscriptions to compare.',
      compareA: 'Subscription A',
      compareB: 'Subscription B',
      comparePlaceholder: 'Select two subscriptions to compare.',
      compareDifferentCurrencyHint: 'Subscriptions use different currencies. Turn on “convert to base currency” to compare.',
      monthlyCost: 'Monthly',
      annualCost: 'Annual',
      diffLabel: 'Difference (A - B)',
