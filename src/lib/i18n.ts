...
const translations: Record<Language, TranslationDict> = {
  es: {
    ...
    settings: {
      ...
      calendarDedicatedHint: 'Si está activo, los eventos se publican en un calendario separado para poder filtrarlos en Google Calendar.',
      calendarAutoSyncAllLabel: 'Auto-sync de suscripciones',
      calendarAutoSyncAllHint: 'Si está activo, los cambios en Suscripciones intentarán sincronizarse automáticamente (si ya hay autorización).',
      openGoogleCalendar: 'Abrir Google Calendar',
    },
    drive: {
      title: 'Google Drive (backup)',
      body: 'Guarda y restaura tus datos usando la carpeta oculta de la app (appDataFolder).',
      lastBackup: 'Última copia',
      save: 'Guardar en Drive',
      restore: 'Restaurar desde Drive',
      saving: 'Guardando…',
      restoring: 'Restaurando…',
      restoreConfirm: 'Esto reemplazará tus datos locales con los de Drive. ¿Continuar?',
  ...
  en: {
    ...
    settings: {
      ...
      calendarDedicatedHint: 'When enabled, events are published to a separate calendar so you can filter them in Google Calendar.',
      calendarAutoSyncAllLabel: 'Auto-sync subscriptions',
      calendarAutoSyncAllHint: 'When enabled, changes in Subscriptions will try to sync automatically (if already authorized).',
      openGoogleCalendar: 'Open Google Calendar',
    },
    drive: {
      title: 'Google Drive (backup)',
      body: 'Save and restore your data using the app hidden folder (appDataFolder).',
      lastBackup: 'Last backup',
      save: 'Save to Drive',
      restore: 'Restore from Drive',
      saving: 'Saving…',
      restoring: 'Restoring…',
      restoreConfirm: 'This will replace your local data with the Drive backup. Continue?',
