...
export type PillNavProps = {
  ...
  logoAlt?: string
  /**
   * First item is used as the logo "Home" destination.
   * All items are also rendered as pills.
   */
  items: PillNavItem[]
  activeHref?: string
  className?: string
...
export default function PillNav({
  ...
  useEffect(() => {
    ...
    // close menu on navigation (activeHref changes)
  ...
  const homeHref = safeItems[0]?.href || '/'
